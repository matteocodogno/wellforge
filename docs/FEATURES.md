...
- [PLAN.md](plans/PLAN.md) — build phases, status, honest deviations
- [Multi-tool support](plans/MULTI-TOOL-SUPPORT.md) — run WellForge on OpenCode or GitHub Copilot (VS Code) via generated [adapters](../adapters/)
