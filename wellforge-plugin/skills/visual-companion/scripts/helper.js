(function() {
  ...
  function sessionKey() {
    try {
      return window.sessionStorage && window.sessionStorage.getItem('forge-vc-session-key');
    } catch (e) {}
    return null;
  }
  ...
  function showTombstone() {
    ...
    el.innerHTML = '<div style="max-width:480px">' +
      ...
      'Ask the designer to bring it back — this page reconnects automatically.</p></div>';
